...
Notation "'guard' '(' a ')' " := (UIf a (USugar (UConstBits Ob)) (UFail (bits_t 0))) (in custom koika at level 86, right associativity, format "'guard' '(' a ')'").
...
Notation "a  '!='  b" := (UUnop (UBits1 UNot) (UBinop UEq a b)) (in custom koika at level 79).
