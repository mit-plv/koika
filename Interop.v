...
Section Interop.
  ...
  Record sga_package_t :=
    { (** [sga_reg_t]: The type of variables used in let bindings.
          Typically [string]. *)
      sga_var_t: Type;
      (** [sga_var_names]: These names are used to generate readable code. *)
      sga_var_names: sga_var_t -> string;
      ...
      (** [sga_custom_fn_names]: These names are used to generate readable code. *)
      sga_custom_fn_names: forall fn: sga_custom_fn_t, string;
  ...
  Record circuit_package_t :=
    { cp_prog: sga_package_t;
      ...
      cp_reg_Env: Env cp_prog.(sga_reg_t);
      ...
      cp_circuit: @state_transition_circuit
                    (cp_prog.(sga_reg_t)) (@interop_fn_t cp_prog.(sga_custom_fn_t))
                    (cp_prog.(sga_reg_types)) (interop_Sigma cp_prog.(sga_custom_fn_types))
                    cp_reg_Env;
    }.

  Definition compile_sga_package (s: sga_package_t) : circuit_package_t :=
