...
(* TODO: Temporary *)
Axiom __magic__ : forall T, T.
Tactic Notation "__magic" := apply __magic__.
...
Module TradPf (External: External_sig) (EnclaveParams: EnclaveParameters)
  ...
  Section Derived_Core0.
    ...
    Definition core0_do_steps__spec :=
      ...
      Definition core0_output_log_equivalent := @Core_Common.output_log_equivalent Core0.private_params.
  ...
  Section Derived_Core1.
    ...
    Definition core1_do_steps__spec :=
      ...
      Definition core1_output_log_equivalent := @Core_Common.output_log_equivalent Core1.private_params.
  ...
  (* TODO: Get rid of this after finishing definitions *)
  Section DerivedSm.
      Definition sm_valid_input := @SM_Common.valid_input Params0.initial_pc Params1.initial_pc
  ...
  Section Derived_Mem.
    ...
    Definition mem_do_steps__spec :=
      ...
      Definition mem_valid_input := @Mem_Common.valid_input
                                          Memory.private_params External.ext
  ...
  Module ModImpl.
    ...
    Section ExtractStep.
      ...
      Definition core0_input (impl_io: mod_step_io) : Core_Common.input_t :=
        Core_Common.step_input (step_io_core0 impl_io).
      Definition core1_input (impl_io: mod_step_io) : Core_Common.input_t :=
        Core_Common.step_input (step_io_core1 impl_io).
      Definition sm_input (impl_io: mod_step_io) : SM_Common.input_t :=
        SM_Common.step_input (step_io_sm impl_io).
      Definition mem_input (impl_io: mod_step_io) : Log Mem_Common.R_public ContextEnv  :=
        Mem_Common.step_input (step_io_mem impl_io).
      Definition core0_feedback (impl_io: mod_step_io) : Core_Common.feedback_t :=
        Core_Common.step_feedback (step_io_core0 impl_io).
      Definition core1_feedback (impl_io: mod_step_io) : Core_Common.feedback_t :=
        Core_Common.step_feedback (step_io_core1 impl_io).
      Definition sm_feedback (impl_io: mod_step_io) : SM_Common.feedback_t :=
        SM_Common.step_feedback (step_io_sm impl_io).
      Definition mem_feedback (impl_io: mod_step_io) : Log Mem_Common.R_public ContextEnv  :=
        Mem_Common.step_feedback (step_io_mem impl_io).

      Ltac extract_impl_step__start :=
        intros; consider do_step_with_metadata; consider compute_mod_outputs;
          fast_destruct_nongoal_matches; simplify_tupless; simpl in *.
      (* slower QED *)
      Ltac extract_impl_step__step :=
        consider do_core0; fast_destruct_nongoal_matches; simplify_tupless; simpl in *;
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl in *;
        consider do_sm; fast_destruct_nongoal_matches; simplify_tupless; simpl in *;
        consider do_mem; fast_destruct_nongoal_matches; simplify_tupless; simpl in *.

      Hint Rewrite @SemanticProperties.log_app_empty_l : log_helpers.

      (* NOTE: Easy to automate, but naive way makes the QED a tad slower? How do we do better? *)

      Lemma do_step_core0_input_empty :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        core0_input impl_io = log_empty.
      Proof.
        ...
        apply_equiv_eq.
        consider core0_input.
        intros; autorewrite with log_helpers; auto.
      Qed.

      Lemma core0_do_step_output :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        fst (core0_do_step_input__koika (state_core0 impl_st)
                                      (core0_input impl_io)) =
        output_core0 impl_ev.
      Proof.
        extract_impl_step__start.
        consider do_core0; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        unfold_core0_steps.
      ...
      Lemma core0_do_step_feedback :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        Core_Common.step_feedback (step_io_core0 impl_io) =
        Core_Common.proj_log__pub
          (proj_log (REnv' := ContextEnv) Impl.System.Lift_core0
                    ((lift_log Impl.System.Lift_mem (output_mem impl_ev))++
                     (lift_log Impl.System.Lift_sm (output_sm impl_ev))++
                     (lift_log Impl.System.Lift_core1 (output_core1 impl_ev)))%log).
      Proof.
        extract_impl_step__start.
        consider do_core0; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_sm; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_mem; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        rewrite SemanticProperties.log_app_empty_r.
        rewrite SemanticProperties.log_app_assoc; auto.
      Qed.

      Lemma core1_do_step_input :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        core1_input impl_io =
          Core_Common.proj_log__pub
            (proj_log (REnv' := ContextEnv) Impl.System.Lift_core1 (lift_log Impl.System.Lift_core0 (output_core0 impl_ev))).
      Proof.
        extract_impl_step__start.
        consider core1_input; simpl.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_core0; destruct_all_matches; simplify_tupless.
        autorewrite with log_helpers; auto.
      Qed.

      Lemma core1_do_step_output :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        fst (core1_do_step_input__koika (state_core1 impl_st)
                                      (core1_input impl_io)) =
        output_core1 impl_ev.
      Proof.
        extract_impl_step__start.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        unfold_core1_steps.
      ...
      Lemma core1_do_step_feedback :
        ...
        Core_Common.proj_log__pub
          (proj_log (REnv' := ContextEnv) Impl.System.Lift_core1
                    ((lift_log Impl.System.Lift_mem (output_mem impl_ev))++
                     (lift_log Impl.System.Lift_sm (output_sm impl_ev)))%log).
      Proof.
        extract_impl_step__start.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_sm; fast_destruct_nongoal_matches; simplify_tupless; simpl.
      ...
      Lemma sm_do_step_input :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        sm_input impl_io =
          SM_Common.proj_log__pub
            (proj_log (REnv' := ContextEnv) Impl.System.Lift_sm
                      ((lift_log Impl.System.Lift_core1 (output_core1 impl_ev)) ++ (lift_log Impl.System.Lift_core0 (output_core0 impl_ev)))%log).
      Proof.
        extract_impl_step__start.
        consider do_sm; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl.
      ...
      Lemma sm_do_step_output :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        fst (Impl.System.SM.do_step_input__impl (state_sm impl_st)
                                              (sm_input impl_io)) =
        output_sm impl_ev.
      Proof.
        extract_impl_step__start.
        ...
        unfold_sm_steps.
        autorewrite with log_helpers in *.
        consider @SM_Common.do_step_input__impl; simplify_tupless.
        auto.
      Qed.

      Lemma sm_do_step_feedback :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        SM_Common.step_feedback (step_io_sm impl_io) =
        SM_Common.proj_log__pub
      ...
      Lemma mem_do_step_input :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        mem_input impl_io =
          Mem_Common.proj_log__pub
            (proj_log (REnv' := ContextEnv) Impl.System.Lift_mem
                      ((lift_log Impl.System.Lift_sm (output_sm impl_ev)) ++
                       (lift_log Impl.System.Lift_core1 (output_core1 impl_ev)) ++
                       (lift_log Impl.System.Lift_core0 (output_core0 impl_ev)))%log).
      Proof.
        extract_impl_step__start.
        consider mem_input; simpl.
        consider do_mem; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_sm; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_core0; destruct_all_matches; simplify_tupless.
      ...
      Lemma mem_do_step_output :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        fst (mem_do_step_input__impl (state_mem impl_st)
                                   (mem_input impl_io)) =
        output_mem impl_ev.
      Proof.
        extract_impl_step__start.
      ...
      Lemma do_step_mem_feedback_empty :
        forall impl_st impl_st' impl_ev impl_io,
        do_step_with_metadata impl_st = (impl_st', impl_ev, impl_io) ->
        mem_feedback impl_io = log_empty.
      Proof.
        extract_impl_step__start.
        consider do_mem; fast_destruct_nongoal_matches; simplify_tupless; simpl in *.
        apply_equiv_eq.
        consider mem_feedback; simpl.
        intros; autorewrite with log_helpers; auto.
      Qed.
    End ExtractStep.
  ...
  Module ModSpec.
    ...
    Section TODO_MOVE.
      ...
      Definition combine_sm_public_output : SM_Common.spec_output_t ->
    ...
    Section ModularStep.
      ...
      Definition do_sm (st: SM_Common.spec_state_t) (input_log: Log Impl.System.R ContextEnv)
        ...
        let '(sm_output__local, sm_ghost) := combine_sm_public_output sm_output__raw in
        let sm_output__global := lift_log (REnv' := ContextEnv) Impl.System.Lift_sm sm_output__local in
        let acc := log_app sm_output__global input_log in
        let mk_sm_step_io feedback_log :=
            {| SM_Common.step_input := sm_input;
    ...
    Section ExtractStep.
      Definition core0_input (spec_io: mod_step_io) : Core_Common.input_t :=
        Core_Common.step_input (step_io_core0 spec_io).
      Definition core1_input (spec_io: mod_step_io) : Core_Common.input_t :=
        Core_Common.step_input (step_io_core1 spec_io).
      Definition sm_input (spec_io: mod_step_io) : SM_Common.input_t :=
        SM_Common.step_input (fst (step_io_sm spec_io)).
      Definition mem_input (spec_io: mod_step_io) : Mem_Common.input_t :=
        (Mem_Common.step_input (Mem_Common.ghost_step (step_io_mem spec_io)),
         (Mem_Common.ghost_input_config0 (step_io_mem spec_io),
          Mem_Common.ghost_input_config1 (step_io_mem spec_io))).
      Definition core0_feedback (spec_io: mod_step_io) : Core_Common.feedback_t :=
        Core_Common.step_feedback (step_io_core0 spec_io).
      Definition core1_feedback (spec_io: mod_step_io) : Core_Common.feedback_t :=
        Core_Common.step_feedback (step_io_core1 spec_io).
      Definition sm_feedback (spec_io: mod_step_io) : SM_Common.feedback_t :=
        SM_Common.step_feedback (fst (step_io_sm spec_io)).
      Definition mem_feedback (spec_io: mod_step_io) : Mem_Common.feedback_t :=
        (Mem_Common.step_feedback (Mem_Common.ghost_step (step_io_mem spec_io))).
      ...
      Lemma do_step_core0_input_empty :
        ...
        do_step_with_metadata spec_st = (spec_st', spec_ev, spec_io) ->
        core0_input spec_io = log_empty.
      Proof.
      ...
      Lemma core0_do_step_output :
        forall spec_st spec_st' spec_ev spec_io,
        do_step_with_metadata spec_st = (spec_st', spec_ev, spec_io) ->
        fst (core0_do_step_trans_input__spec (state_core0 spec_st) (core0_input spec_io)) =
        output_core0 spec_ev.
      Proof.
        extract_spec_step__start.
        consider do_core0; fast_destruct_nongoal_matches; simplify_tupless.
        unfold_core0_steps.
        autorewrite with log_helpers in *.
        consider @Core_Common.proj_log__pub.
        consider @Core_Common.do_step_trans_input__spec; consider @Core_Common.do_step_input__koika; simplify_tupless.
        simpl.
        consider core0_input; simpl.
        auto.
      Qed.
      ...
      Lemma core0_do_step_feedback :
        forall spec_st spec_st' spec_ev spec_io,
          ...
          Core_Common.proj_log__pub
            (proj_log (REnv' := ContextEnv) Impl.System.Lift_core0
                      ((lift_log Impl.System.Lift_mem (combine_mem_public_output ((output_mem spec_ev))))++
                      (lift_log Impl.System.Lift_sm (fst (combine_sm_public_output (output_sm spec_ev))))++
                      (lift_log Impl.System.Lift_core1 (output_core1 spec_ev)))%log).
      Proof.
        extract_spec_step__start.
        rewrite SemanticProperties.log_app_empty_r; auto.
        consider do_mem; fast_destruct_nongoal_matches; simplify_tupless; simpl.
      ...
      Lemma core1_do_step_input :
        ...
        core1_input spec_io =
          Core_Common.proj_log__pub
            (proj_log (REnv' := ContextEnv) Impl.System.Lift_core1 (lift_log Impl.System.Lift_core0 (output_core0 spec_ev))).
      Proof.
        extract_spec_step__start.
        consider core1_input; simpl.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl.
      ...
      Lemma core1_do_step_output :
        forall spec_st spec_st' spec_ev spec_io,
        do_step_with_metadata spec_st = (spec_st', spec_ev, spec_io) ->
        fst (core1_do_step_trans_input__spec (state_core1 spec_st) (core1_input spec_io)) =
        output_core1 spec_ev.
      Proof.
        extract_spec_step__start.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless.
        unfold_core1_steps.
        autorewrite with log_helpers in *.
        consider @Core_Common.proj_log__pub.
        consider @Core_Common.do_step_trans_input__spec; consider @Core_Common.do_step_input__koika; simplify_tupless.
      ...
      Lemma core1_do_step_feedback :
        forall spec_st spec_st' spec_ev spec_io,
          ...
          Core_Common.proj_log__pub
            (proj_log (REnv' := ContextEnv) Impl.System.Lift_core1
                      ((lift_log Impl.System.Lift_mem (combine_mem_public_output ((output_mem spec_ev))))++
                                                                                                                         (lift_log Impl.System.Lift_sm (fst (combine_sm_public_output (output_sm spec_ev))))%log)%log).
      Proof.
        extract_spec_step__start.
        rewrite SemanticProperties.log_app_empty_r; auto.
        consider do_mem; fast_destruct_nongoal_matches; simplify_tupless; simpl.
      ...
      Lemma sm_do_step_input :
        ...
        sm_input spec_io =
          (SM_Common.proj_log__pub
            (proj_log (REnv' := ContextEnv) Impl.System.Lift_sm
                      ((lift_log Impl.System.Lift_core1 (output_core1 spec_ev)) ++
                       (lift_log Impl.System.Lift_core0 (output_core0 spec_ev)))%log)).
      Proof.
        extract_spec_step__start.
        consider sm_input; simpl.
        consider do_sm; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_core1; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        consider do_core0; fast_destruct_nongoal_matches; simplify_tupless; simpl.
        rewrite SemanticProperties.log_app_empty_l.
      ...
      Lemma sm_do_step_output :
        forall spec_st spec_st' spec_ev spec_io,
        do_step_with_metadata spec_st = (spec_st', spec_ev, spec_io) ->
        Impl.System.SM.do_step_input__spec (state_sm spec_st)
                                         (sm_input spec_io) =
        output_sm spec_ev.
      Proof.
        extract_spec_step__start.
        consider do_sm; fast_destruct_nongoal_matches; simplify_tupless.
        unfold_sm_steps.
          ...
          (Mem_Common.proj_log__pub
            (proj_log (REnv' := ContextEnv) Impl.System.Lift_mem
                      ((lift_log Impl.System.Lift_sm (fst (combine_sm_public_output (output_sm spec_ev)))) ++
                       (lift_log Impl.System.Lift_core1 (output_core1 spec_ev)) ++
                       (lift_log Impl.System.Lift_core0 (output_core0 spec_ev)))%log),
            ((ghost_output_config0 (snd (combine_sm_public_output (output_sm spec_ev)))),
             (ghost_output_config1 (snd (combine_sm_public_output (output_sm spec_ev)))))).
      Proof.
        extract_spec_step__start.
        (* QED is faster with unfolding inputs? *)
        consider mem_input; simpl.
        consider sm_input; simpl.
        consider core1_input; simpl.
        consider core0_input; simpl.
      ...
      Lemma mem_do_step_output :
        forall spec_st spec_st' spec_ev spec_io,
        do_step_with_metadata spec_st = (spec_st', spec_ev, spec_io) ->
        mem_do_step_trans_input__spec (state_mem spec_st)
                                    (mem_input spec_io) =
        output_mem spec_ev.
      Proof.
        extract_spec_step__start.
        consider do_mem; fast_destruct_nongoal_matches; simplify_tupless.
        unfold_mem_steps.
        autorewrite with log_helpers in *; simpl.
        consider mem_input; simpl.
        auto.
      ...
      Lemma do_step_mem_feedback_empty :
        forall spec_st spec_st' spec_ev spec_io,
        do_step_with_metadata spec_st = (spec_st', spec_ev, spec_io) ->
        mem_feedback spec_io = log_empty.
      Proof.
        extract_spec_step__start.
        consider do_mem; fast_destruct_nongoal_matches; simplify_tupless; simpl in *.
        apply_equiv_eq.
    ...
    Section Invariant.
      ...
      Ltac unfold_props' :=
        consider valid_inputs;
        consider valid_outputs;
        consider valid_feedbacks.

      Definition AND_nil : AND [] := ltac:(consider AND; simpl; auto).

      Lemma valid_props_app_l :
        forall l1 l2 dram,
    ...
    Section PropsLemmas.
      Lemma valid_props_extract_core1_valid_input :
        forall ios spec_st0 t initial_dram n,
        step_n_with_metadata initial_dram n = (spec_st0, t, ios) ->
        valid_props initial_dram (ios ++ [snd (do_step_with_metadata spec_st0)]) ->
        core1_valid_input (state_core1 spec_st0) (core1_input (snd (do_step_with_metadata spec_st0))).
      Admitted.

      Lemma valid_props_extract_sm_valid_input :
        forall ios spec_st0 t initial_dram n,
        step_n_with_metadata initial_dram n = (spec_st0, t, ios) ->
        valid_props initial_dram (ios ++ [snd (do_step_with_metadata spec_st0)]) ->
        sm_valid_input (state_sm spec_st0) (sm_input (snd (do_step_with_metadata spec_st0))).
      Admitted.

      Lemma valid_props_extract_mem_valid_input :
        forall ios spec_st0 t initial_dram n,
        step_n_with_metadata initial_dram n = (spec_st0, t, ios) ->
        valid_props initial_dram (ios ++ [snd (do_step_with_metadata spec_st0)]) ->
        mem_valid_input (state_mem spec_st0) (mem_input (snd (do_step_with_metadata spec_st0))).
      Admitted.
  ...
  Module ModImplToModSpec.
    ...
    Section LiftProperties.
      ...
      Lemma cores_do_not_share_registers :
        ~ (exists reg1 reg2, rlift Impl.System.Lift_core0 reg1 = rlift Impl.System.Lift_core1 reg2).
      Proof.
        intuition.
        destruct reg1; destruct reg2; simpl in *;
          consider Impl.System.Lift_core0; consider Impl.System.Lift_core1;
      ...
      Lemma proj_core0_lift_core1_equiv :
        forall log1 log2,
          ...
          proj_log (REnv := ContextEnv) (REnv' := ContextEnv)
                   Impl.System.Lift_core0 (lift_log Impl.System.Lift_core1 log1) =
      ...
      Lemma proj_core0_lift_sm_equiv :
        forall log1 log2,
          SM_Common.output_log_equivalent log1 log2 ->
          proj_log (REnv := ContextEnv) (REnv' := ContextEnv)
                   Impl.System.Lift_core0 (lift_log Impl.System.Lift_sm log1) =
      ...
      Lemma proj_core0_lift_mem_equiv :
        forall log1 log2,
          ...
          proj_log (REnv := ContextEnv) (REnv' := ContextEnv)
                   Impl.System.Lift_core0 (lift_log Impl.System.Lift_mem log1) =
      ...
      Lemma proj_core1_lift_core0_log_equiv :
        forall log1 log2,
          Core_Common.proj_log__pub log1 = Core_Common.proj_log__pub log2 ->
          proj_log (REnv := ContextEnv) (REnv' := ContextEnv)
                   Impl.System.Lift_core1 (lift_log Impl.System.Lift_core0 log1) =
          proj_log (REnv' := ContextEnv) Impl.System.Lift_core1 (lift_log Impl.System.Lift_core0 log2).
      Proof.
        intros.
        consider @Core_Common.proj_log__pub.
        consider @proj_log.
        ...
        - repeat rewrite getenv_lift_log_not_exists; auto;
            intuition; apply cores_do_not_share_registers;
      ...
      Lemma proj_core1_lift_sm_equiv :
        forall log1 log2,
          SM_Common.output_log_equivalent log1 log2 ->
          proj_log (REnv := ContextEnv) (REnv' := ContextEnv)
                   Impl.System.Lift_core1 (lift_log Impl.System.Lift_sm log1) =
          proj_log (REnv' := ContextEnv) Impl.System.Lift_core1
                   (lift_log Impl.System.Lift_sm (fst (ModSpec.combine_sm_public_output log2))).
      Admitted.
      ...
      Lemma proj_core1_lift_mem_equiv :
        forall log1 log2,
          mem_output_log_equivalent log1 log2 ->
          proj_log (REnv := ContextEnv) (REnv' := ContextEnv)
                   Impl.System.Lift_core1 (lift_log Impl.System.Lift_mem log1) =
          proj_log (REnv' := ContextEnv) Impl.System.Lift_core1
                   (lift_log Impl.System.Lift_mem (ModSpec.combine_mem_public_output log2)).
      Admitted.

      Lemma proj_sm_lift_core0_log_equiv :
        forall log1 log1' ,
          Core_Common.proj_log__pub log1 = Core_Common.proj_log__pub log1' ->
          (proj_log (REnv := ContextEnv) (REnv' := ContextEnv) Impl.System.Lift_sm
                    (lift_log Impl.System.Lift_core0 log1)) =
          (proj_log (REnv' := ContextEnv) Impl.System.Lift_sm
                    (lift_log Impl.System.Lift_core0 log1')).
      Proof.
        intros. consider @Core_Common.proj_log__pub.
        consider @proj_log.
        apply_equiv_eq; intros; repeat rewrite getenv_create.
        destruct k.
        - admit.
        - repeat rewrite getenv_lift_log_not_exists; auto; intuition;
            simpl in *; destruct reg; simpl in *; try congruence;
              destruct r; simpl in *; congruence.
      Admitted.

      Lemma proj_sm_lift_core1_log_equiv :
        forall log1 log1' ,
          Core_Common.proj_log__pub log1 = Core_Common.proj_log__pub log1' ->
          (proj_log (REnv := ContextEnv) (REnv' := ContextEnv) Impl.System.Lift_sm
                    (lift_log Impl.System.Lift_core1 log1)) =
          (proj_log (REnv' := ContextEnv) Impl.System.Lift_sm
                    (lift_log Impl.System.Lift_core1 log1')).
      Admitted.
      ...
      Lemma sm_output_log_equiv_impl_combine_public_output :
        forall impl_out spec_out,
          ...
          SM_Common.proj_log__pub impl_out =
          SM_Common.proj_log__pub (fst (ModSpec.combine_sm_public_output spec_out)).
      Proof.
        intros. consider SM_Common.output_log_equivalent.
        apply_equiv_eq.
        intros. consider SM_Common.proj_log__pub.
        repeat rewrite getenv_create.
        consider ModSpec.combine_sm_public_output; simpl.
        destruct spec_out; simpl. rewrite getenv_create.
        specialize H with (reg := SM_Common.public k).
        simpl in H.
        destruct_all_matches; auto.
      Qed.

      Lemma proj_mem_lift_core0_log_equiv :
        forall log1 log1' ,
          Core_Common.proj_log__pub log1 = Core_Common.proj_log__pub log1' ->
          (proj_log (REnv := ContextEnv) (REnv' := ContextEnv) Impl.System.Lift_mem
                    (lift_log Impl.System.Lift_core0 log1)) =
          (proj_log (REnv' := ContextEnv) Impl.System.Lift_mem
                    (lift_log Impl.System.Lift_core0 log1')).
      Admitted.

      Lemma proj_mem_lift_core1_log_equiv :
        forall log1 log1' ,
          Core_Common.proj_log__pub log1 = Core_Common.proj_log__pub log1' ->
          (proj_log (REnv := ContextEnv) (REnv' := ContextEnv) Impl.System.Lift_mem
                    (lift_log Impl.System.Lift_core1 log1)) =
      ...
      Lemma proj_mem_lift_sm_log_equiv :
        forall log1 log1' ,
          SM_Common.proj_log__pub log1 = SM_Common.proj_log__pub log1' ->
          (proj_log (REnv := ContextEnv) (REnv' := ContextEnv) Impl.System.Lift_mem
      ...
      Lemma mem_output_log_equiv_impl_combine_public_output :
        forall impl_out spec_out,
          ...
          (proj_log (REnv := ContextEnv) (REnv' := ContextEnv)
                    Impl.System.Lift_sm (lift_log Impl.System.Lift_mem impl_out)) =
          (proj_log (REnv' := ContextEnv) Impl.System.Lift_sm
    ...
    Section Simulation.
      ...
      Ltac unfold_short_ios :=
        consider ModImpl.core0_input;
        consider ModImpl.core1_input;
        consider ModImpl.sm_input;
        consider ModImpl.mem_input;
        consider ModSpec.core0_input;
        consider ModSpec.core1_input;
        consider ModSpec.sm_input;
        consider ModSpec.mem_input.
      ...
      Proof.
        ...
        - intros *; intros HImpl HSpec.
          ...
          assert (ModImpl.core0_input impl_io = log_empty) as HImplCore0Empty
             by (eapply ModImpl.do_step_core0_input_empty; eauto).
          assert (ModSpec.core0_input spec_io = log_empty) as HSpecCore0Empty
             by (eapply ModSpec.do_step_core0_input_empty; eauto).
          (* Core0 input eq *)
          assert (ModImpl.core0_input impl_io = ModSpec.core0_input spec_io) as Heq_core0_input.
          { rewrite_solve. }
          (* Core0 output eq *)
          assert (core0_output_log_equivalent (ModImpl.output_core0 impl_ev)
                                              (ModSpec.output_core0 spec_ev)) as Heq_core0_output.
          { rewrite forall_sim_step_extract_core0 with (1 := IHn) in *.
            consider core0_output_log_equivalent.
            eapply Core0.output_correctness with (input := ModImpl.core0_input impl_io); eauto.
            - rewrite_term_from_tuple prop_core0; unfold_spec_props; intuition.
            - rewrite_term_from_tuple prop_core0; unfold_spec_props; intuition.
            - rewrite<-ModImpl.core0_do_step_output with (1 := HImplStep); auto.
            - rewrite<-ModSpec.core0_do_step_output with (1 := HSpecStep); unfold_core0_steps; rewrite_solve.
          }
          (* Core1 input *)
          assert (ModImpl.core1_input impl_io = ModSpec.core1_input spec_io) as Heq_core1_input.
          {
            rewrite ModImpl.core1_do_step_input with (1 := HImplStep).
            rewrite ModSpec.core1_do_step_input with (1 := HSpecStep).
            consider core0_output_log_equivalent.
            consider @Core_Common.output_log_equivalent.
            consider @Core_Common.ext_log_equivalent.
            erewrite proj_core1_lift_core0_log_equiv; eauto.
          }
          (* Core1 output *)
          assert (core1_output_log_equivalent (ModImpl.output_core1 impl_ev)
                                              (ModSpec.output_core1 spec_ev)) as Heq_core1_output.
          { rewrite forall_sim_step_extract_core1 with (1 := IHn) in *.
            consider core1_output_log_equivalent.
            eapply Core1.output_correctness with (input := ModSpec.core1_input spec_io); eauto.
            - rewrite_term_from_tuple prop_core1; clear - HSpecProp; unfold_spec_props; propositional.
            - rewrite_term_from_tuple prop_core1; clear - HSpecProp; unfold_spec_props; propositional.
            - rewrite_term_from_tuple spec_io.
              eapply ModSpec.valid_props_extract_core1_valid_input; eauto.
              rewrite_solve.
            - rewrite<-ModImpl.core1_do_step_output with (1 := HImplStep); rewrite_solve.
            - rewrite<-ModSpec.core1_do_step_output with (1 := HSpecStep); auto.
          }
          (* SM input *)
          assert (ModImpl.sm_input impl_io = ModSpec.sm_input spec_io) as Heq_sm_input.
          { rewrite ModImpl.sm_do_step_input with (1 := HImplStep).
            rewrite ModSpec.sm_do_step_input with (1 := HSpecStep).
            consider core0_output_log_equivalent.
            consider core1_output_log_equivalent.
            consider SM_Common.proj_log__pub.
            apply_equiv_eq; intros; repeat rewrite getenv_create.
            repeat rewrite<-log_app_comm_proj_log.
            repeat rewrite getenv_logapp.
            erewrite proj_sm_lift_core0_log_equiv; eauto.
            erewrite proj_sm_lift_core1_log_equiv; eauto.
          }
          (* SM output *)
          assert (SM_Common.output_log_equivalent (ModImpl.output_sm impl_ev)
                                                  (ModSpec.output_sm spec_ev)) as Heq_sm_output.
          { rewrite forall_sim_step_extract_sm with (1 := IHn) in *.
            consider Impl.System.SM.do_steps__spec.
            consider Impl.System.SM.do_steps__impl.
            apply SM_Common.output_correctness with (input := ModSpec.sm_input spec_io) (3 := HSpecSM) (4 := HImplSM).
            - rewrite_term_from_tuple prop_sm; clear - HSpecProp; unfold_spec_props; propositional.
            - rewrite_term_from_tuple prop_sm; clear - HSpecProp; unfold_spec_props; propositional.
            - rewrite_term_from_tuple spec_io.
              eapply ModSpec.valid_props_extract_sm_valid_input; eauto.
              rewrite_solve.
            - rewrite<-ModImpl.sm_do_step_output with (1 := HImplStep); rewrite_solve.
            - rewrite<-ModSpec.sm_do_step_output with (1 := HSpecStep); auto.
          }
          (* Mem input *)
          assert (ModImpl.mem_input impl_io = fst (ModSpec.mem_input spec_io)) as Heq_mem_input.
          { rewrite ModImpl.mem_do_step_input with (1 := HImplStep).
            rewrite ModSpec.mem_do_step_input with (1 := HSpecStep).
            consider core0_output_log_equivalent.
            consider core1_output_log_equivalent.
            consider @Mem_Common.proj_log__pub.
            apply_equiv_eq; intros; repeat rewrite getenv_create; simpl.
            rewrite getenv_create.
            repeat rewrite<-log_app_comm_proj_log.
            repeat rewrite getenv_logapp; simpl.
            erewrite proj_mem_lift_core0_log_equiv; eauto.
            erewrite proj_mem_lift_core1_log_equiv; eauto.
            erewrite proj_mem_lift_sm_log_equiv; eauto.
            apply sm_output_log_equiv_impl_combine_public_output; auto.
          }
          (* Mem output *)
          assert (mem_output_log_equivalent (ModImpl.output_mem impl_ev)
                                            (ModSpec.output_mem spec_ev)) as Heq_mem_output.
          { rewrite forall_sim_step_extract_mem with (1 := IHn) in *.
            consider mem_output_log_equivalent.
            consider mem_do_steps__impl.
            consider mem_do_steps__spec.
            pose proof Memory.output_correctness as MemOutputCorrect. consider @Mem_Common.P_output_correctness.
            eapply MemOutputCorrect with (input := ModSpec.mem_input spec_io); eauto.
            - rewrite_term_from_tuple prop_mem; clear - HSpecProp; unfold_spec_props; propositional.
            - rewrite_term_from_tuple prop_mem; clear - HSpecProp; unfold_spec_props; propositional.
            - rewrite_term_from_tuple spec_io.
              eapply ModSpec.valid_props_extract_mem_valid_input; eauto.
              rewrite_solve.
            - rewrite<-ModImpl.mem_do_step_output with (1 := HImplStep); rewrite_solve.
            - rewrite<-ModSpec.mem_do_step_output with (1 := HSpecStep); auto.
          }

          (* ======= Equiv feedback, backwards ====== *)
          assert (Mem_Common.step_feedback (ModImpl.step_io_mem impl_io) = log_empty) as HImplMemFBEmpty.
          { eapply ModImpl.do_step_mem_feedback_empty; eauto.
          }
          assert (Mem_Common.step_feedback (Mem_Common.ghost_step (ModSpec.step_io_mem spec_io)) = log_empty)
            as HSpecMemFBEmpty.
          { eapply ModSpec.do_step_mem_feedback_empty; eauto. }
          ...
          assert (SM_Common.step_feedback (ModImpl.step_io_sm impl_io)
            ...
            as Heq_sm_feedback.
          { rewrite ModImpl.sm_do_step_feedback with (1 := HImplStep).
            rewrite ModSpec.sm_do_step_feedback with (1 := HSpecStep).
            apply f_equal.
          ...
          { rewrite ModImpl.core1_do_step_feedback with (1 := HImplStep).
            rewrite ModSpec.core1_do_step_feedback with (1 := HSpecStep).
            apply f_equal.
            repeat rewrite<-log_app_comm_proj_log.
          ...
          { rewrite ModImpl.core0_do_step_feedback with (1 := HImplStep).
            rewrite ModSpec.core0_do_step_feedback with (1 := HSpecStep).
            apply f_equal.
            repeat rewrite<-log_app_comm_proj_log.
          ...
          (* ======= Solve ====== *)
          constructor;
            destruct_with_eqn impl_io; destruct_with_eqn spec_io; simpl in *;
              repeat match goal with
              | H: Core_Common.step_io |- _ => destruct H
              | H: SM_Common.step_io * _  |- _ => destruct H
              | H: SM_Common.step_io |- _ => destruct H
