...
EXAMPLES := $(wildcard examples/*.lv) $(wildcard examples/*.v) examples/rv/rv32i.v examples/rv/rv32e.v examples/dynamic_isolation/rv32i.v examples/dynamic_isolation/rv32e.v
