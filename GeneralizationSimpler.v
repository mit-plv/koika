...
Definition bottomValue := Bottom.

Inductive sort_write : Type :=
| write_0 : nat -> value -> sort_write
| write_past : nat -> value -> sort_write
| write_1 : nat ->  value -> sort_write
| write_past_1 : nat -> value -> sort_write.

Inductive sort_read : Type :=
| read: nat -> sort_read
| forward: nat -> sort_read.


Notation ReadLog := (list (sort_read)).
Notation WriteLog := (list (sort_write)).



Inductive ActionValue : Type :=
  | avlet : ActionValue -> (value -> ActionValue ) -> ActionValue
  | avif: ActionValue  -> ActionValue  -> ActionValue
  | avread : nat -> nat -> ActionValue
  | avread1 : nat -> nat -> ActionValue
  | avwrite : nat -> nat -> value -> ActionValue
  | avwrite1 : nat -> nat -> value -> ActionValue
  | avlift: (forall (v1:value) (v2:value), value) -> ActionValue  -> ActionValue  -> ActionValue
  (* avcall: nat -> value -> scheduler -> ActionValue scheduler sur le sous etat! *)
  | avblock : ActionValue
  | avempty : ActionValue.
